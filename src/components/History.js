...
import {  getVideoById } from '../util/utils.js';
...
function Explore(props){
    ...
    useEffect(()=>{
        props.setSidebarActive('history');
        window.scrollTo(0, 0);
        props.setHeadTitleAsVideoTitle("MeTube");
        props.setIsHome(true);


        var videos= getVideoById(window.sessionStorage.getItem("videoHistory"));
    ...
    <div className="explore">
        <div className={(props.nav.sidebarMin?"main-body-minSidebar":"main-body")}>
            <div className="trendingVideos">
                <div className="trendingVideos-heading">History</div>
